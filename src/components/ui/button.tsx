  ...
  "inline-flex items-center justify-center gap-3 whitespace-nowrap rounded-xl text-lg font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-6 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive text-destructive-foreground shadow-danger hover:bg-destructive/90 hover:shadow-lg",
        safe:
          "bg-safe text-safe-foreground shadow-safe hover:bg-safe/90 hover:shadow-lg",
        outline:
      ...
      size: {
        ...
        lg: "min-h-[64px] px-10 py-5 text-xl",
        xl: "min-h-[72px] px-12 py-6 text-2xl rounded-2xl",
        icon: "h-14 w-14",
      },
    },
    defaultVariants: {
